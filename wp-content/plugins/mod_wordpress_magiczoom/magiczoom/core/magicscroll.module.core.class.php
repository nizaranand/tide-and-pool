...
if(!defined('MagicScrollModuleCoreClassLoaded')) {
    ...
    class MagicScrollModuleCoreClass {
        ...
        function headers($jsPath = '', $cssPath = null, $notCheck = false) {
            ...
            $headers = array();
            // add module version
            $headers[] = '<!-- Magic Zoom WordPress module version v5.10.5 [v1.2.39:v4.0.25] -->';
            // add style link
